...
def main():
    ...
    biased, unbiased = generate_paired_datasets(n=1000, beta_biased=-0.15, seed=42)
    ...
    print(f"\nDIR (biased)   = {disparate_impact_ratio(biased,   'Race', 'Loan'):.3f}")
    print(f"DIR (unbiased) = {disparate_impact_ratio(unbiased, 'Race', 'Loan'):.3f}")
