...
using the compas-scores.csv will not be allow you to duplicate the information from the article or in the paper. Use the compas-scores-two-years.csv because it also includes the follow up information on recidivism) and place it at:
